...
**1,680 家投資機構 · 1,279 家公司 · 12 個地區 · 1,497 條投資關係連結** —— 0 schema 違規、0 critical QA。

- 投資機構:100% 有來源 URL、96% 帶原文引用,共 4,888 條來源。信心度 high 823 / medium 766 / low 91
- 公司:100% 有來源 URL、99% 帶原文引用。信心度 high 379 / medium 676 / low 224
- 連結圖:1,497 條邊,其中 **286 條由兩邊各自獨立主張、互相印證**;717/1,279 家公司與 646/1,680 家機構已連上
- 待辦:937 家被收錄機構點名、但尚未建檔的公司(見 `reports/links.json`)
...
**公司依領域**:新藥開發/生技製藥 371 · 醫療器材 147 · 數位健康 119 · 診斷/精準檢測 106 · 醫療服務/照護 95 · 醫療資訊系統 86 · 細胞與基因治療 67 · 醫學影像 64 · 製藥服務(CRO/CDMO) 40 · AI製藥/計算生物 38

**公司狀態**:未上市 608 · 已上市 479 · 已被併購 144 · 已結束營運 15
<!-- STATS:END -->
